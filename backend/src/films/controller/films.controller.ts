...
import { getAllFilmsDTO } from '../dto/films.dto';

interface AllFilmsResponse {
  total: number;
  items: getAllFilmsDTO[];
}

const allFilms: getAllFilmsDTO[] = [
  {
  ...
  {
    id: '5c3bd384-197a-4a60-b556-aa45a18753bb',
    rating: 9,
  ...
  {
    id: '52aef841-b957-48a3-ae15-880235e1cfed',
    rating: 8.5,
  ...
  {
    id: '5b82b2df-bcb6-42c4-9690-607283b90ade',
    rating: 8.9,
  ...
  {
    id: '0057a0ab-5a19-48e7-b52e-952058fc3331',
    rating: 9.5,
  ...
  {
    id: '910b6e49-868b-40a8-a17c-e94ca9ebed09',
    rating: 8.1,
